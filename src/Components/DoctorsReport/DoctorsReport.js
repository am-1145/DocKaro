...
import DoctorsReportTable from "./DoctorsReportTable";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-2xl">Doctor's Report </span>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          >
            <span>Doctors' Report Table</span>
          </div>
          ...
          <div className="flex p-[20px] flex-col justify-center items-start  space-y-2">
            ...
            <div className="w-full flex items-center justify-start px-0 py-1">
