...
const Invoices = () => {
  ...
  return (
    ...
    >
      ...
      >
        <LiaFileInvoiceDollarSolid style={{ fontSize: "27px" }} />
        ...
        >
          ...
          <div className="flex p-[20px] flex-col justify-center items-start space-y-2">
            <div className="w-full flex flex-col">
              <button
                className="w-full  flex items-center justify-center rounded py-[5px] font-semibold text-white bg-[#0448BB] hover:shadow-md hover:shadow-[#0448BB] space-x-2 mb-2"
                onClick={() => {
                  setOpen(!open);
                }}
              >
