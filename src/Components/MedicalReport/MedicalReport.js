...
const MedicalReport = () => {
  ...
  return (
    ...
    >
      ...
      >
        <TbReportMedical style={{ fontSize: "27px" }} />
      ...
      >
        ...
        >
          ...
          >
            <span>Medical Report's Table</span>
            {/* <button className="bg-[#0448BB] flex text-white items-center px-2 py-1 rounded space-x-1 hover:shadow-md hover:shadow-[#0448BB]">
              <span>+</span>
              <span>Create</span>
            </button> */}
          </div>
